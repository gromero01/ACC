...
################################################################################
  ...
  for (ii in seq(length(cfaSepar))) {
    temp <- cfa(fixStructUnivBlock, sample.cov = corList[[ii]], 
...
################################################################################   
  ...
  res$fit.configural <- cfa(fixStructUnivBlock, sample.cov = corList, 
                            sample.nobs = nObsBlockI, std.lv = TRUE, 
                            estimator = "ML", orthogonal = FALSE, 
                            group.equal = "")
  res$fit.loadings   <- cfa(fixStructUnivBlock, sample.cov = corList, 
                            sample.nobs = nObsBlockI, std.lv = TRUE, 
                            estimator = "ML", orthogonal = FALSE, 
                            group.equal = c("loadings")) # # metric
  res$fit.intercepts <- cfa(fixStructUnivBlock, sample.cov = corList, 
                            sample.nobs = nObsBlockI, std.lv = TRUE, 
                            estimator = "ML", orthogonal = FALSE, 
                            group.equal = c("loadings","intercepts"))
  res$fit.residuals <- cfa(fixStructUnivBlock, sample.cov = corList, 
                            sample.nobs = nObsBlockI, std.lv = TRUE, 
                            estimator = "ML", orthogonal = FALSE, 
                            group.equal = c("loadings",
                                           "intercepts", "residuals"))
  res$fit.varianceFa <- cfa(fixStructUnivBlock, sample.cov = corList, 
                            sample.nobs = nObsBlockI, std.lv = TRUE, 
                            estimator = "ML", orthogonal = FALSE, 
                            group.equal = c("loadings",
                                           "intercepts", "residuals",
  ...
  res$fit.covarianceFa <- cfa(fixStructUnivBlock, sample.cov = corList, 
                            sample.nobs = nObsBlockI, std.lv = TRUE, 
                            estimator = "ML", orthogonal = FALSE, 
                            group.equal = c("loadings",
                                           "intercepts", "residuals",
